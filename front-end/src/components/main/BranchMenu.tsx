        ...
        {branches
          ...
          .map((branch) => (
            <button
              ...
              className="cursor-pointer border-none bg-transparent p-0 text-left text-[11px]/[130%] font-normal text-cp-text-branch transition-colors duration-[120ms] ease-cp hover:text-cp-text-primary"
            >
              {branch}
            </button>
          ))}
