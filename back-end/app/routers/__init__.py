...
the composer, `deploy.py` the Archive shelf, `access.py` the door people come in through. A
route added for a screen has an obvious home, and reading one file tells you
everything one screen can do.
"""

from fastapi import APIRouter

from . import access, branches, commits, deploy, projects, settings, team
